...
@interface GLCalendarMonthView()<UICollectionViewDataSource, UICollectionViewDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
@implementation GLCalendarMonthView
...
- (void)setup
{
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"GLCalendarDayCell" bundle:[NSBundle frameworkBundle]] forCellWithReuseIdentifier:CELL_REUSE_IDENTIFIER];
...
{
    GLCalendarMonthView *appearance = [[self class] appearance];
